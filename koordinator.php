  ...
  <a class="navbar-brand" href="#">SELAMAT DATANG ADMIN | <b>Kantin Sehat SMK JP1</b></a>
    ...
    <div class="row no-gutters mt-5">
        ...
        <div class="col-md-10 p-5 pt-2">
            <h3><i class="fas fa-users mr-2"></i>KOORDINATOR KANTIN SEHAT SMK JP 1</h3><hr> 

            <div class="row text-white justify-content-center pt-2">
         <div class="card bg-primary ml-5" style="width: 18rem;">
                <div class="card-body">
                    <div class="card-body-icon" id="iconkoor">
                        <i class="fas fa-female"></i>
                    </div>
                    <h5 class="card-title">Ketua Koordinator</h5>
                    <h5 class="text-white">Bu H.J Sari Marwati</h5>
                    <a href=""><p class="card-text text-white">LIHAT DETAIL INFO KETUA KOORDINATOR <i class="fas fa-angle-double-right ml-2"></i></p></a>
        ...
        <div class="row mt-4">
        <div class="card bg-info ml-5" style="width: 18rem; height: 10rem;">
                <div class="card-body">
                    <div class="card-body-icon" id="iconkoor">
                        <i class="fas fa-male"></i>
                    </div>
                    <h5 class="card-title">Wakil Koordinator</h5>
                    <h5 class="text-white">Bpk Agus Ramdan</h5>
                    <a href=""><p class="card-text text-white">LIHAT DETAIL INFO WAKIL KOORDINATOR<i class="fas fa-angle-double-right ml-2"></i></p></a>
                </div>
            </div>
            <div class=" ml-5 text-white text-center" style="width: 18rem;">
                
                
                <div class="card-body">
                    <img src="img/jp1.png" alt="" width="120px;"> 
            ...
            <div class="card-body">
                    ...
                    <h5 class="card-title">Wakil Koordinator 2</h5>
                    <h5 class="text-white">Bpk Firman Aulia</h5>
                    <a href=""><p class="card-text text-white">LIHAT DETAIL INFO WAKIL KOORDINATOR <i class="fas fa-angle-double-right ml-2"></i></p></a>
                </div>
            </div>
</div>
